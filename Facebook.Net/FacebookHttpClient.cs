...
namespace FacebookDotNet
{
    ...
    public class FacebookHttpClient
    {
        ...
        public async Task<T> GetObject<T>(string url, FacebookRequestType requestType, HttpContent data = null)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                switch (requestType)
                {
                    case FacebookRequestType.GET:
                        response = await client.GetAsync(url);
                        break;
                    case FacebookRequestType.POST:
                        response = await client.PostAsync(url, data);
                        break;
                    case FacebookRequestType.PUT:
        ...
        public async Task<T> PostObject<T>(string url, HttpContent data)
        {
            using (var client = new HttpClient())
            {
                client.BaseAddress = new Uri(url);
